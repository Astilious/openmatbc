...
class WTank(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        self.fontSize = int(self.parent().height() / 30.)
        self.letterFont = QtGui.QFont(
            "sans-serif", self.fontSize, QtGui.QFont.Bold)
    ...
    def setLabel(self, level=0):
        ...
        self.tankLevel.setGeometry(
            QtCore.QRect(self.ulx, self.uly + self.tankHeight, self.tankWidth, self.fontSize*2))
    ...
    def setLetter(self, letter):
        ...
        self.tankLetter.setGeometry(
            QtCore.QRect(self.ulx - self.fontSize*2, self.uly, self.fontSize*2, self.fontSize*2))
