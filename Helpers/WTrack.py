...
class WTrack (QtWidgets.QWidget):
    ...
    def moveCursor(self, multiplier=1.0):
        current_time_ms = int(self.parent().parent().totalElapsedTime_ms) - self.timeOffset
        ...
        for thisCoord in ['x', 'y']:
            ...
            self.cursorPos[thisCoord] += translation*multiplier
    ...
    def setCursorX(self, x):
        self.refreshCursorPosition(x, self.cursorPos['y'])

    def setCursorY(self, y):
        self.refreshCursorPosition(self.cursorPos['x'], y)
